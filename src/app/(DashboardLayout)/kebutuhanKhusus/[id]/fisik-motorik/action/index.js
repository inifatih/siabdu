...
export const insertFisikMotorik = async (identitasAnak_id, skor1) => {
  ...
  const hasil1 = skor1 >= 100 ? "Tunadaksa" : "Tidak teridentifikasi";
  ...
  try {
    ...
    const { data: categoryData, error: categoryError } = await supabase
      ...
      .insert([
        { kategori: "Fisik Motorik", hasil: hasil1, skor: skor1 },
      ])
      .select();
    ...
    const { data: resultData, error: resultError } = await supabase
      ...
      .insert([
        {
          identitasAnak_id,
          jenis_hambatan: "Fisik Motorik",
          hasil: `Fisik Motorik: ${hasil1}`,
          skor: skor1,
        },
      ])
      .select()
