...
export const insertAutism = async (identitasAnak_id, skor1) => {
  ...
  const hasil1 = skor1 >= 100 ? "Autis" : "Tidak teridentifikasi";
  ...
  try {
    ...
    const { data: categoryData, error: categoryError } = await supabase
      ...
      .insert([
        { kategori: "Autism", hasil: hasil1, skor: skor1 },
      ])
      .select();
