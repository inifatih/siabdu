...
export const insertPenglihatan = async (identitasAnak_id, skor1, skor2) => {
  ...
  const hasil1 = skor1 >= 100 ? "Buta" : "Tidak teridentifikasi";
  const hasil2 = skor2 >= 100 ? "Low Vision" : "Tidak teridentifikasi";
  ...
  try {
    ...
    const { data: categoryData, error: categoryError } = await supabase
      ...
      .insert([
        { kategori: "Buta", hasil: hasil1, skor: skor1 },
        { kategori: "Low Vision", hasil: hasil2, skor: skor2 },
      ])
      .select();
    ...
    const { data: resultData, error: resultError } = await supabase
      ...
      .insert([
        {
          identitasAnak_id,
          jenis_hambatan: "penglihatan",
          hasil: `Buta: ${hasil1}, Low Vision: ${hasil2}`,
          skor: skor1 + skor2,
        },
      ])
      .select()
