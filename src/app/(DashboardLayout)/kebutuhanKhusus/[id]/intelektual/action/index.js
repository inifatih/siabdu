...
export const insertIntelektual = async (identitasAnak_id, skor1) => {
  ...
  const hasil1 = skor1 >= 100 ? "Tunagrahita" : "Tidak teridentifikasi";
  ...
  try {
    ...
    const { data: categoryData, error: categoryError } = await supabase
      ...
      .insert([
        { kategori: "Intelektual", hasil: hasil1, skor: skor1 },
      ])
      .select();
    ...
    const { data: resultData, error: resultError } = await supabase
      ...
      .insert([
        {
          identitasAnak_id,
          jenis_hambatan: "Intelektual",
          hasil: `Intelektual: ${hasil1}`,
          skor: skor1,
        },
      ])
      .select()
