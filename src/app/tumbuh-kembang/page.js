            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div className="gap-y-4">
                        ...
                        <h2 className="font-semibold text-gray-600 mt-6 mb-2">Skrining Tumbuh Kembang Anak Usia 4 Bulan</h2>
                        {/* Pertanyaan 1 */}
                        <div className="p-2">
                            <FormField
                                control={form.control}
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="font-semibold text-sm text-gray-600">1. Apakah anak mampu menumpu kedua lengan dan berusaha untuk mengangkat kepala?</FormLabel>
                                        <FormControl>
                                            <RadioGroup
                                                value={field.value || ""}
